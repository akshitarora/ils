...
} else { header('Location: http://pratik.acslab.org/index.php'); die(); }
...
if($landslide == 1) {
$_SESSION['day'] += 1;
        header('Location: http://pratik.acslab.org/landslide_positive.php'); die();
}
    else{ $_SESSION['day'] += 1;
header('Location: http://pratik.acslab.org/landslide_negative.php'); die();}
